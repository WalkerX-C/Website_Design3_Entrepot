...
<body>
    ...
    <?php if(isset($_SESSION['success_msg'])) { ?>
        <div class="notice success">
            <?php
                echo homepage_h($_SESSION['success_msg']);
    ...
    <?php if(isset($_SESSION['error_msg'])) { ?>
        <div class="notice error">
            <?php
                echo homepage_h($_SESSION['error_msg']);
    ...
    <section class="homepage_product_group">
        <div class="homepage_group_header homepage_floating" data-delay="0.06">
            <h3 class="homepage_group_title">Recently Listed</h3>
            <div class="homepage_carousel_controls">
                <button type="button" aria-label="Previous latest products" onclick="homepage_scrollCarousel('homepage_latest_carousel', -1)">&#8249;</button>
                <button type="button" aria-label="Next latest products" onclick="homepage_scrollCarousel('homepage_latest_carousel', 1)">&#8250;</button>
            </div>
        </div>

        <div id="homepage_latest_carousel" class="homepage_product_grid homepage_carousel_track">
    ...
    <section class="homepage_product_group">
        <div class="homepage_group_header homepage_floating" data-delay="0.06">
            <h3 class="homepage_group_title">More to Explore</h3>
            <div class="homepage_carousel_controls">
                <button type="button" aria-label="Previous explore products" onclick="homepage_scrollCarousel('homepage_explore_carousel', -1)">&#8249;</button>
                <button type="button" aria-label="Next explore products" onclick="homepage_scrollCarousel('homepage_explore_carousel', 1)">&#8250;</button>
            </div>
        </div>

        <div id="homepage_explore_carousel" class="homepage_product_grid homepage_explore_grid homepage_carousel_track">
    ...
    <script>
        ...
        function homepage_scrollCarousel(carouselId, direction) {
            ...
            var scrollAmount = carousel.clientWidth * 0.88;
