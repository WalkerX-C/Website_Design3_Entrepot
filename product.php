<?php
/*
    MY Store - Product Detail Page

    This page receives productID from homepage:
    product.php?id=1

    It reads product data from MySQL products table,
    and shows one product detail page.
...
<body>
    ...
    <header class="top-header">
        ...
        <div class="header-actions">
            <a class="bag-top-link" href="cart.php">Bag</a>
            <a class="header-icon" href="homepage.php">
